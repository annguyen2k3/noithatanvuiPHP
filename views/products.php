                            ...
                            <form id="filter">
                                    ...
                                    <div class="pt-6" id="filter-section-0">
                                        <div class="space-y-4">
                                            <div class="flex gap-x-4 items-center">
                                                <p class="w-1/12">Từ</p>
                                                <input name="price-min" class="bg-white pl-2 rounded-md py-1" type="number" placeholder="100.000">
                                                &#8363;
                                            </div>
                                            <div class="flex gap-x-4 items-center">
                                                <p class="w-1/12">Đến</p>
                                                <input name="price-max" class="bg-white pl-2 rounded-md py-1" type="number" placeholder="10.000.000">
                                                &#8363;
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="border-b border-gray-200 py-6">
                                    ...
                                    <div class="pt-6" id="filter-section-1">
                                        <div class="space-y-4">
                                            <div class="flex items-center">
                                                <input id="filter-category-1" name="material[]" value="Gỗ, sắt>" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                                                <label for="filter-category-1" class="ml-3 text-sm text-gray-600 truncate">Gỗ, sắt</label>
                                            </div>
                                            <div class="flex items-center">
                                                <input id="filter-category-2" name="material[]" value="Gỗ, sắt>" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                                                <label for="filter-category-2" class="ml-3 text-sm text-gray-600 truncate">Nhựa</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="mt-4">
                                    <button id="btn-filter" type="button" class="bg-blue-500 hover:bg-blue-700 text-white py-1 px-6 rounded">Lọc</button>
                                </div>
                            </form>
                        </div>
